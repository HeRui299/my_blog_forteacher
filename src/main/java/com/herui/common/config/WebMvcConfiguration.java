...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/admin/updatePassword.html").setViewName("admin/updatePassword");
        registry.addViewController("/admin/setting.html").setViewName("admin/setting");
    }

    @Override
    protected void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(loginInterceptor).addPathPatterns("/admin/**","/config/**").excludePathPatterns("/admin/login","/admin/kaptcha","/admin");
    }
}